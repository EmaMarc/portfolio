    ...
    >
      ...
      <div className="mt-12 grid gap-x-10 gap-y-14 lg:grid-cols-[minmax(17rem,0.42fr)_minmax(0,0.58fr)] lg:gap-x-16 lg:gap-y-12">
        <div className="order-2 lg:order-1 lg:row-span-2">
          <figure className="mx-auto w-[92%] max-w-[21.5rem] min-[390px]:w-[86%] sm:w-[78%] sm:max-w-[23rem] md:w-[62%] md:max-w-[24rem] lg:sticky lg:top-24 lg:mx-0 lg:ml-3 lg:w-[88%] lg:max-w-[23.5rem] xl:ml-5 xl:max-w-[25rem]">
